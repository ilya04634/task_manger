# Generated by Django 6.0.3 on 2026-04-02 09:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('USER', 'Пользователь'), ('MODERATOR', 'Модератор')], default='USER', max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('PROJECT', 'Проектный'), ('PERSONAL', 'Личный')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admins', models.ManyToManyField(related_name='administered_projects', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddField(
            model_name='chatroom',
            name='project',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='api.project'),
        ),
        migrations.CreateModel(
            name='Task',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('TODO', 'К выполнению'), ('IN_PROGRESS', 'В процессе'), ('DONE', 'Готово')], default='TODO', max_length=15)),
                ('title', models.CharField(max_length=255)),
                ('description', models.TextField(blank=True)),
                ('importance', models.CharField(choices=[('LOW', 'Низкий'), ('MED', 'Средний'), ('HIGH', 'Высокий')], default='MED', max_length=4)),
